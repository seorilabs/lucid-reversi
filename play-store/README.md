...
- Store 이미지 자산: `assets/`(아이콘 512, 피처그래픽 1024x500 3개 언어), `screenshots/phone/{ko-KR,en-US,ja-JP}`(1080x1920, 언어당 5장), `screenshots/tablet`(1200x1920 3장, 7인치·10인치 공용, 기본 언어에만 올린다)
