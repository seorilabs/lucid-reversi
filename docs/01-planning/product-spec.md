...
- Non-gameplay controls live in the top-right settings menu: 난이도, 사운드, 진동, 보드/돌 테마, 언어. Mobile settings use large segmented buttons instead of select boxes, and tapping outside the settings panel closes it.
